filter_details = {
  ...
  "has_authenticated_orcid": { "possible_values": None , "description": "metadata which includes one or more ORCIDs where the depositing publisher claims to have witness the ORCID owner authenticate with ORCID"},
  ...
  "type": { "possible_values": None, "description": "metadata for records with type matching a type identifier (e.g. journal-article)" },
  ...
  "has_assertion": { "possible_values": None, "description": "metadata for records with any assertions" },
  ...
  "has_abstract": { "possible_values": None, "description": "metadata for records which include an abstract" },
  "has_clinical_trial_number": { "possible_values": None, "description": "metadata for records which include a clinical trial number" },
  "content_domain": { "possible_values": None, "description": "metadata where the publisher records a particular domain name as the location Crossmark content will appear" },
  "has_content_domain": { "possible_values": None, "description": "metadata where the publisher records a domain name location for Crossmark content" },
  "has_crossmark_restriction": { "possible_values": None, "description": "metadata where the publisher restricts Crossmark usage to content domains" },
  "has_relation": { "possible_values": None, "description": "metadata for records that either assert or are the object of a relation" },
  "relation_type": { "possible_values": None, "description": "One of the relation types from the Crossref relations schema (e.g. is-referenced-by, is-parent-of, is-preprint-of)" },
  "relation_object": { "possible_values": None, "description": "Relations where the object identifier matches the identifier provided" },
  "relation_object_type": { "possible_values": None, "description": "One of the identifier types from the Crossref relations schema (e.g. doi, issn)" },
